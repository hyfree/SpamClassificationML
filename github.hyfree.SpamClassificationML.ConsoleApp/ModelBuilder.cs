...
namespace Github_hyfree_SpamClassificationML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"E:\github\github.hyfree.SpamClassification\github.hyfree.SpamClassification\Data\带标签短信.txt";
        private static string MODEL_FILEPATH = @"C:\Users\WangXianQiang\AppData\Local\Temp\MLVSTools\github.hyfree.SpamClassificationML\github.hyfree.SpamClassificationML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Text.FeaturizeText("value_tf", "value")
                                      .Append(mlContext.Transforms.CopyColumns("Features", "value_tf"))
                                      .Append(mlContext.Transforms.NormalizeMinMax("Features", "Features"))
                                      .AppendCacheCheckpoint(mlContext);
            // Set the training algorithm 
            var trainer = mlContext.BinaryClassification.Trainers.AveragedPerceptron(labelColumnName: "lable", numberOfIterations: 10, featureColumnName: "Features");
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.BinaryClassification.CrossValidateNonCalibrated(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "lable");
